...
public extension Date {
    ...
    var calendar: Calendar {
        ...
        return Calendar.autoupdatingCurrent // (identifier: Calendar.current.identifier)
    }
...
public extension Date {
    ...
    /// - Returns: date string.
//    func string(withFormat format: DateFormat = .ddMMMMyyyy) -> String {
//        let dateFormatter = DateFormatter()
...
// MARK: - Date in millisecondsSince1970
extension Date {
...
extension Date {
    /// Return a relative date and time string representation for the date with the given formatter
    func relativeDateTimeString(with formatter: RelativeDateTimeFormatter = .relativeDateTimeFormatter) -> String {
...
extension Date {
    /// Return a string representation for the date with the given formatter
